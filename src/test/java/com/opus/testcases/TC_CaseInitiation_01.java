...
public class TC_CaseInitiation_01 extends BaseClass {
	String firstName;
	String middleName;

	// Verify Bridge Login Test
	@Test(enabled = true, testName = "Bridge Login Test", priority = 1)
	...
	@Test(enabled = true, testName = "Verify Bridge Case Add Details", priority = 2, dependsOnMethods = {
			"bridgeLoginTest" })
	...
	@Test(enabled = true, testName = " Verify Case allocated to highlighter Allocator", priority = 3, dependsOnMethods = {
	...
	// Highlighter
	@Test(enabled = true, testName = "Verify Case allocated to highlighter", priority = 4, dependsOnMethods = {
	...
	@Test(enabled = true, testName = "Verify Case Documentation Specialist", priority = 5, dependsOnMethods = {
	...
	@Test(enabled = true, testName = "Verify Docs Qc Allocator", priority = 6, dependsOnMethods = {
	...
	@Test(enabled = true, testName = "Verify Docs Quality", priority = 7, dependsOnMethods = {
	...
	@Test(enabled = true, testName = "Verify Case Allocation", priority = 8, dependsOnMethods = {
